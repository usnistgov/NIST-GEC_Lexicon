# Contributing to NIST-GEC_Lexicon

:+1: First of all: Thank you for taking the time to contribute!

The following is a set of guidelines for contributing to
NIST-GEC_Lexicon. These guidelines are not strict rules.
...
The NIST-GEC_Lexicon team strives to create a
...
- Pull Requests
    ...
    - PRs should be reviewed and merged in a timely fashion by the NIST-GEC_Lexicon technical leads
...
[issues]: https://github.com/NIST/NIST-GEC_Lexicon/issues/
[pulls]: https://github.com/NIST/NIST-GEC_Lexicon/pulls/
